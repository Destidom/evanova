...
public class MarketGroupListWidget extends AbstractListRecyclerView<EveMarketGroup> {
    ...
    public MarketGroupListWidget(Context context) {
        super(context);
    }

    public MarketGroupListWidget(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MarketGroupListWidget(Context context, AttributeSet attrs, int defStyleAttr) {
